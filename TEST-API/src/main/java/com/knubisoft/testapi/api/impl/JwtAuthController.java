...
import com.knubisoft.testapi.api.JwtAuthApi;
...
import com.knubisoft.testapi.security.jwt.JWTGenerator;
...
public class JwtAuthController implements JwtAuthApi {
    ...
    public ResponseEntity<AuthResponseDto> jwtLogin(LoginDto loginDto) {
