<template>
    <div @keydown.esc="open = false">
        ...
        <button @click="showAlert"
                class="px-6 py-3 ml-4 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-red-600 rounded-md hover:bg-red-500 focus:outline-none focus:bg-red-500"
                id="alert-button">
            Alert Button
        </button>
