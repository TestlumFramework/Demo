      ...
      <form class="mt-4" @submit.prevent="login">
        ...
        <div class="flex items-center justify-between mt-4">
          <div>
            ...
            <div>
                <button @click="handleClick" @dblclick="handleDoubleClick" class="block text-sm text-indigo-700 fontme hover:underline" id="dblClickButton">Forgot your password?</button>
            </div>
        </div>
...
const password = ref("@#johndoe1233");
...
function handleDoubleClick(event: MouseEvent) {
  alert('Do,uble click detected on the button!');
  event.preventDefault();
}
</script>
